...
public class NewsServiceImpl implements NewsService {
    ...
    public void initNews() {
        ...
        news1.setPostDate(LocalDateTime.of(2022, 12, 9, 16, 45));
        ...
        news2.setPostDate(LocalDateTime.of(2022, 12, 7, 20, 34));
        ...
        news3.setPostDate(LocalDateTime.of(2023, 3, 23, 17, 29));
        ...
        news4.setPostDate(LocalDateTime.of(2023, 3, 16, 11, 48));
